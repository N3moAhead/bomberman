...
func Details(csrf string, user *models.User, vm *viewmodels.MatchDetail, historyJson string) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Var2 := templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
			...
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 7, "\"><script>\n      const historyInput = document.getElementById(\"historyData\");\n      const history = JSON.parse(\n        JSON.parse(historyInput.getAttribute(\"history-data\")),\n      );\n\n      // TODO: The mapping from player ID to bot name is currently based on the order of players in the first tick.\n      // This is not reliable. A stable identifier should be provided from the backend to link players in the history to the bots in the match.\n      const playerIDToName = {};\n      const bot1Name = \"")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			templ_7745c5c3_Var9, templ_7745c5c3_Err := templruntime.ScriptContentInsideStringLiteral(vm.Match.Bot1.Name)
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/templates/matches/details.templ`, Line: 63, Col: 45}
			}
